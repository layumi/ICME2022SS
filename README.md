...
**Motivation**
This special session is proposed in response to the increasing importance and demands for Responsible, Responsive, and Robust (3R) multimedia retrieval. Multimedia retrieval techniques are widely used in our daily life to search for relevant materials from large information corpuses. The common applications include the search engine, online shopping and social media sites. Due to the strong representation ability of the deeply-learned models, the learned embeddings become the dominant representation in multimedia retrieval. Despite the great success of such data-driven approaches, it remains questionable whether the learned retrieval models are robust and unbiased in reflecting the real needs of users, serving the good of society, and reliable in a variety of real-world scenarios. Along with the rapid development of AI-based multimedia applications, we begin to witness the emergence of fatal failure cases, such as the accidents caused by auto-driving vehicles, the privacy leaks on public datasets, and the return of biased uninformative results, etc. This motivates us to find a balance between privacy, explainability and robustness, along with the usual metrics of effectiveness and efficiency, to better understand what the retrieval systems should and should not do. Hence in this special session, we hope to initiate discussions and promote new research directions that can help us to better understand the retrieval models and improve their reliability instead of just accuracy. 
...
| ![avatar](https://zdzheng.xyz/images/profile.jpg) |![avatar](./picture/2.png) |![avatar](http://zheng-lab.cecs.anu.edu.au/1.jpg) |
| :-: | :-: | :-: |
